...
class QuoteBox extends React.Component{
    ...
    render(){
      return(
        <div id="quote-box">
            <QuoteText quote={quotes[this.state.quoteNumber].quoteText}/>
            <QuoteAuthor author={quotes[this.state.quoteNumber].quoteAuthor}/>
            <QuoteButtons newQuote={this.handleNewQuoteClick}/>
        </div>
      );
    };
}
